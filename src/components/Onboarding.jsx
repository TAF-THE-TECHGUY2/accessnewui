...
const FAQ_CATEGORIES = [
  ...
  },
  {
    ...
    questions: [
      { q: "What is the minimum investment?", a: "The minimum investment for the current offering is $25,000. Specific minimums may vary by fund and investor pathway." },
    ...
    switch (currentStep) {
      ...
      case "amount": {
        ...
        if (parsed < MIN_INVESTMENT) {
          setInvestmentAmountError(
            "Minimum investment is $25,000. Try '25000', '$25,000', or '25k'.",
          );
          return;
        }
        navigateTo("overview");
